...
class Services {
    ...
    private final static com.oxycast.chromecastapp.cloudserver.Services ourInstance = new com.oxycast.chromecastapp.cloudserver.Services();
    ...
    static com.oxycast.chromecastapp.cloudserver.Services getInstance() {
        return ourInstance;
    }
