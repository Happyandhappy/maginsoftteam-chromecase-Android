...
public class InAppPurchase1 {
    // Debug tag, for logging
    static final String TAG = "Chrome_Case";

 //   static final String SKU_REMOVE_ADS = "com.chrome.demo";
   ...
   String base64EncodedPublicKey = "";
    Boolean isAdsDisabled = false;
    String payload = "dasdasdsadsassdfdgsdsxzfsdd";

    public InAppPurchase1(Activity launcher) {
